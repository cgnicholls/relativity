...
public class OneParameterSubgroup {
	...
	public GL2C mobiusAtParameter(final double t) {
		...
		return _matrixOfEVectors.multiply(GL2C.diagonal(Complex.polars(Math.exp(_logMagnitude * t), polarAngleAtT), Complex.polars(Math.exp(-_logMagnitude * t), -polarAngleAtT * t))).multiply(_matrixOfEVectorsInverse);
	}
